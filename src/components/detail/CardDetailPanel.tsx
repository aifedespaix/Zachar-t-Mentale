      ...
      <header style={{ display: 'flex', alignItems: 'flex-start', gap: 4, padding: '8px 8px 8px 10px' }}>
        ...
        {!pinned && (
          <Button
            variant="ghost"
            size="icon-sm"
            aria-label={`Épingler la fiche de ${card.title}`}
            title="Épingler : la fiche reste ouverte quand une autre est consultée"
            onClick={onPin}
          >
            <Pin />
          </Button>
        ...
        {pinned && (
          <Button
            variant="ghost"
            size="icon-sm"
            aria-label={`Détacher la fiche de ${card.title}`}
            title="Épinglée"
            onClick={onClose}
          >
            <PinOff />
